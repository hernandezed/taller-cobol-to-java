...
public class CreateCryptoPayment implements CreatePayment<CryptoPayment> {
    @Override
    public CryptoPayment create(Scanner in) {
        ...
        return new CryptoPayment(payerData, amount, beneficiaryData);
    }
}
